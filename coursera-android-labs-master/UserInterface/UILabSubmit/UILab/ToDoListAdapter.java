...
public class ToDoListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = RelativeLayout.inflate(mContext,R.layout.todo_item, null);
            ...
            sViewHolder.priorityView = (TextView) convertView.findViewById(R.id.priorityView);
        ...
        // from todo_item.xml
        //sViewHolder.itemLayout = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.todo_item, null);
